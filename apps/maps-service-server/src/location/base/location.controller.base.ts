...
import { FavoriteLocationsFindManyArgs } from "../../favoriteLocations/base/FavoriteLocationsFindManyArgs";
import { FavoriteLocations } from "../../favoriteLocations/base/FavoriteLocations";
...
export class LocationControllerBase {
  ...
  @common.Get("/:id/favoriteLocationsItems")
  @ApiNestedQuery(FavoriteLocationsFindManyArgs)
  async findFavoriteLocationsItems(
    @common.Req() request: Request,
    @common.Param() params: LocationWhereUniqueInput
  ): Promise<FavoriteLocations[]> {
    const query = plainToClass(FavoriteLocationsFindManyArgs, request.query);
    const results = await this.service.findFavoriteLocationsItems(params.id, {
      ...query,
      select: {
        createdAt: true,
        id: true,
  ...
  @common.Post("/:id/favoriteLocationsItems")
  async connectFavoriteLocationsItems(
    @common.Param() params: LocationWhereUniqueInput,
    @common.Body() body: FavoriteLocationsWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Patch("/:id/favoriteLocationsItems")
  async updateFavoriteLocationsItems(
    @common.Param() params: LocationWhereUniqueInput,
    @common.Body() body: FavoriteLocationsWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Delete("/:id/favoriteLocationsItems")
  async disconnectFavoriteLocationsItems(
    @common.Param() params: LocationWhereUniqueInput,
    @common.Body() body: FavoriteLocationsWhereUniqueInput[]
  ): Promise<void> {
    const data = {
